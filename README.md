...
* An helm chart is available of in the [chart folder](https://github.com/digrouz/docker-sonarr/tree/master/chart) with an example [values.yaml](https://github.com/digrouz/docker-sonarr/tree/master/chart/values.yaml)
